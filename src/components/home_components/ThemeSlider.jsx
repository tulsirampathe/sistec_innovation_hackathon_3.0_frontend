      ...
      <section className="themes container">
        <div className="paddings innerWidth theme-container">
          <div className="theme-head flexColStart">
            <span className="primaryText">SIH 3.0 Themes</span>
          </div>
  ...
  return (
    <>
      <section className="themes container">
        <div className="paddings innerWidth theme-container">
          <div className="theme-head flexColStart">
            <span className="primaryText">SIH 2024 Themes</span>
          </div>
...
export { ThemeSlider2k23, ThemeSlider2k24 };
