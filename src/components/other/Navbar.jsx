          ...
          <nav className="menu">
            ...
            <ul>
              ...
              <li className="dropdown">
                ...
                <button className="dropdown-button">Previous SIH</button>
                ...
                <ul className="sub-menu">
                  ...
                  <li className="dropdown">
                    ...
                    <ul className="sub-menu sub-menu-left">
                      ...
                      <li>
                        <NavLink to="/sih 2023 grand finale">
                          <span>Grand Finale Teams</span>
                        </NavLink>
                      </li>
                      <li>
                        <NavLink to="/sih 2023 winners">
                          <span>Winner of SIH 2023</span>
                        </NavLink>
                      </li>
                    </ul>
                  ...
                  {/* SIH 2.0 */}
                  <li className="dropdown">
                    <button className="dropdown-button">SIH 2.0</button>
                    ...
                    <ul className="sub-menu sub-menu-left">
                      ...
                      <li>
                        <NavLink to="/sih 2024 grand finale">
                          <span>Grand Finale Teams</span>
                        </NavLink>
                      </li>
                      <li>
                        <NavLink to="/sih 2024 winners">
                          <span>Winner of SIH 2024</span>
                        </NavLink>
                      </li>
                    </ul>
